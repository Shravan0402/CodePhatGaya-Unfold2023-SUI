import type { Checkpoint, DynamicFieldInfo, SuiCallArg, SuiMoveNormalizedModule, SuiParsedData, SuiTransaction, SuiValidatorSummary } from '@mysten/sui.js/dist/cjs/client/types/generated.js';
...
export type SuiMoveObject = Extract<SuiParsedData, {
    dataType: 'moveObject';
}>;
export type SuiMovePackage = Extract<SuiParsedData, {
    dataType: 'package';
}>;
