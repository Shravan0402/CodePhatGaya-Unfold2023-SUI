import { PublicKey } from '@mysten/sui.js/dist/cjs/cryptography/publickey.js';
import type { SignatureScheme } from '@mysten/sui.js/dist/cjs/cryptography/signature-scheme.js';
import type { SerializedSignature } from '@mysten/sui.js/dist/cjs/cryptography/signature.js';
...
export declare class MultiSigPublicKey extends PublicKey {
     ...
     */
    verify(message: Uint8Array, multisigSignature: SerializedSignature): Promise<boolean>;
    /**
